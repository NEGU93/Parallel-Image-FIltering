...
A master task split the input images in subpart and send each subpart to a slave task, which compute the blur filter.
After the work, the master task merge each part of the original image and finish the blur filter iteration.
