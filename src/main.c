...
int main( int argc, char ** argv ) {
    ...
    image = load_pixels( input_filename ); // Optimize this
    ...
    apply_gray_filter( image ) ;  // Optimize this 3 filters
    ...
    if ( !store_pixels( output_filename, image ) ) { return 1 ; } // Optimize storing
